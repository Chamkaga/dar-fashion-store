...
(2, 'Linen Summer Dress', 'linen-summer-dress', 'DFS-WOM-001', 48000.00, 42000.00, 'https://images.unsplash.com/photo-1525507119028-ed4c629a60a3?auto=format&fit=crop&w=600&q=80', 'Light and stylish dress for warm Dar es Salaam weather. Made from 100% premium linen fabric, this dress offers exceptional breathability and comfort. Features a flattering A-line silhouette with a relaxed fit, perfect for casual outings, beach days, or summer events. The lightweight material drapes beautifully and resists wrinkles, making it ideal for travel. Available in multiple colors to suit your personal style.', 'S,M,L,XL', 'White,Beige,Orange', 24, 1, 1),
(2, 'Printed Kitenge Set', 'printed-kitenge-set', 'DFS-WOM-002', 58000.00, 52000.00, 'https://images.unsplash.com/photo-1539008835657-9e8e9680c956?auto=format&fit=crop&w=600&q=80', 'Colorful fashion set inspired by local Tanzanian style. This vibrant Kitenge set includes a matching top and skirt made from high-quality cotton fabric with traditional African prints. The fabric is soft, durable, and machine washable. Perfect for cultural events, parties, or making a bold fashion statement. The set offers a comfortable fit with elastic waistband for easy wear.', 'S,M,L,XL', 'Mixed Print', 20, 0, 1),
(2, 'Casual Blouse', 'casual-blouse', 'DFS-WOM-003', 35000.00, NULL, 'https://images.unsplash.com/photo-1506629082847-11d3e392e467?auto=format&fit=crop&w=600&q=80', 'Perfect everyday blouse for the office or casual outings. Crafted from soft, breathable cotton blend fabric, this blouse features a classic button-down design with a comfortable fit. The versatile style pairs well with jeans, skirts, or dress pants. Available in a variety of colors to match your wardrobe. Machine washable for easy care.', 'S,M,L,XL,XXL', 'Pink,Blue,White,Black', 28, 1, 0),
(2, 'Evening Gown', 'evening-gown', 'DFS-WOM-004', 95000.00, 85000.00, 'https://images.unsplash.com/photo-1566126842435-f0dc07b30cfb?auto=format&fit=crop&w=600&q=80', 'Elegant evening gown for special occasions. This stunning floor-length gown features a flowing silhouette with delicate details. Made from premium satin fabric, it offers a luxurious feel and beautiful drape. Perfect for weddings, galas, formal dinners, or any special event. The gown includes a concealed zipper for a seamless look.', 'S,M,L,XL', 'Black,Red,Navy', 10, 1, 1),
(2, 'Denim Jacket', 'denim-jacket', 'DFS-WOM-005', 62000.00, 55000.00, 'https://images.unsplash.com/photo-1551028719-00167b16ebc5?auto=format&fit=crop&w=600&q=80', 'Classic denim jacket for layering and style. This timeless denim jacket features a comfortable fit with classic button closure and chest pockets. Made from durable denim fabric that softens with each wash. Perfect for layering over dresses, blouses, or t-shirts. The versatile design works for casual outings, shopping trips, or weekend adventures.', 'S,M,L,XL,XXL', 'Blue,Black,Light Blue', 35, 1, 0),
...
(1, 'Classic Men Shirt', 'classic-men-shirt', 'DFS-MEN-001', 35000.00, 31000.00, 'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?auto=format&fit=crop&w=600&q=80', 'Clean smart casual shirt for work and events. This premium cotton shirt features a classic fit with a comfortable collar and button-down design. The fabric is breathable and wrinkle-resistant, making it perfect for all-day wear. Ideal for office meetings, business casual events, or smart casual outings. Machine washable for easy maintenance.', 'M,L,XL,XXL', 'Blue,White,Black', 30, 1, 0),
(1, 'Formal Dress Shirt', 'formal-dress-shirt', 'DFS-MEN-002', 45000.00, 40000.00, 'https://images.unsplash.com/photo-1596455056769-12226f253b1e?auto=format&fit=crop&w=600&q=80', 'Premium formal dress shirt for business occasions. This elegant dress shirt is crafted from high-quality cotton with a smooth finish. Features a classic collar, button-down front, and tailored fit. Perfect for business meetings, interviews, formal events, or professional settings. The fabric is wrinkle-resistant and maintains its shape throughout the day.', 'S,M,L,XL,XXL', 'White,Light Blue,Navy', 22, 1, 0),
(1, 'Polo Shirt', 'polo-shirt', 'DFS-MEN-003', 32000.00, 28000.00, 'https://images.unsplash.com/photo-1586308409274-75d440642117?auto=format&fit=crop&w=600&q=80', 'Classic polo shirt for casual elegance. This timeless polo shirt features a comfortable fit with a ribbed collar and cuffs. Made from soft, breathable cotton pique fabric that keeps you cool and comfortable. Perfect for casual outings, weekend activities, golf, or smart casual events. The classic design never goes out of style.', 'M,L,XL,XXL', 'Red,Blue,White,Black', 35, 1, 1),
...
(3, 'Street Sneakers', 'street-sneakers', 'DFS-SHO-001', 72000.00, 65000.00, 'https://images.unsplash.com/photo-1549298916-b41d501d3772?auto=format&fit=crop&w=600&q=80', 'Comfortable sneakers for everyday movement. These stylish sneakers feature a cushioned sole for all-day comfort and support. The upper is made from breathable mesh material that keeps your feet cool. Perfect for walking, running errands, casual outings, or light exercise. The durable rubber sole provides excellent traction on various surfaces.', '39,40,41,42,43,44', 'White,Black,Red', 18, 1, 1),
(3, 'Running Shoes', 'running-shoes', 'DFS-SHO-002', 85000.00, 76000.00, 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=600&q=80', 'Professional running shoes for athletes. These high-performance running shoes feature advanced cushioning technology for maximum shock absorption. The breathable upper mesh provides excellent ventilation, while the durable rubber outsole offers superior traction. Perfect for marathon training, daily runs, or athletic activities. Lightweight design for enhanced speed.', '38,39,40,41,42,43,44,45', 'Black,Blue,Yellow', 14, 1, 0),
...
(4, 'Everyday Tote Bag', 'everyday-tote-bag', 'DFS-BAG-001', 42000.00, 37000.00, 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?auto=format&fit=crop&w=600&q=80', 'Durable tote bag for shopping, work, and travel. This spacious tote bag features reinforced handles and a sturdy construction. Made from high-quality canvas material that is both stylish and durable. Perfect for grocery shopping, carrying work essentials, weekend trips, or daily use. The interior includes a zippered pocket for valuables.', 'One Size', 'Brown,Black,Tan', 16, 1, 0),
...
(4, 'Handbag Leather', 'handbag-leather', 'DFS-BAG-003', 68000.00, 61000.00, 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?auto=format&fit=crop&w=600&q=80', 'Premium leather handbag for style. This elegant handbag is crafted from genuine leather with a smooth finish. Features multiple compartments for organization, including a zippered main compartment and interior pockets. The adjustable shoulder strap allows for versatile carrying options. Perfect for work, events, or everyday use.', 'One Size', 'Black,Brown,Red', 12, 1, 0),
...
(5, 'Minimal Wrist Watch', 'minimal-wrist-watch', 'DFS-ACC-001', 44000.00, 39000.00, 'https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&w=600&q=80', 'Simple watch that works with formal and casual outfits. This minimalist watch features a clean dial with easy-to-read markers. The stainless steel case provides durability, while the genuine leather strap offers comfort. Water-resistant design for everyday wear. Perfect for office, casual outings, or special occasions. Battery included.', 'One Size', 'Gold,Black,Silver', 12, 0, 1),
(5, 'Digital Smartwatch', 'digital-smartwatch', 'DFS-ACC-002', 95000.00, 85000.00, 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=600&q=80', 'Modern smartwatch with health tracking. This advanced smartwatch features a vibrant display with customizable watch faces. Includes heart rate monitoring, step counting, sleep tracking, and notification alerts. Water-resistant design for swimming and showering. Compatible with both iOS and Android devices. Long battery life for all-day use.', 'One Size', 'Black,Silver,Blue', 10, 1, 0),
